...
SELECT *
FROM Mitarbeiter
--ORDER BY abt_id ASC, CASE WHEN stadt IS NOT NULL THEN 0 ELSE 1 END, stadt;
--nicht gannz korrekt, sorga aber dafür, dass die Null einträge am ende landen
ORDER BY abt_id, stadt DESC
